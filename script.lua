...
Tab:AddButton({
	Name = "Beat snow slide 🏔️",
	Callback = function()
		local pl = game.Players.LocalPlayer.Character.HumanoidRootPart
		local location = CFrame.new(-2369, 77, 16)
		local humanoid = game.Players.LocalPlayer.Character.Humanoid
		humanoid:ChangeState(Enum.HumanoidStateType.Jumping)
		wait(0.1)
		pl.CFrame = location
...
Tab:AddButton({
	Name = "Beat elevator fix 🛠️",
	Callback = function()
		local pl = game.Players.LocalPlayer.Character.HumanoidRootPart
		local location = CFrame.new(-34, 244, 33)
		local humanoid = game.Players.LocalPlayer.Character.Humanoid
		humanoid:ChangeState(Enum.HumanoidStateType.Jumping)
		wait(0.1)
		pl.CFrame = location
...
Tab:AddButton({
	Name = "Beat teapot ☕ (op money (use once))",
	Callback = function()
      		local pl = game.Players.LocalPlayer.Character.HumanoidRootPart
