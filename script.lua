...
local Window = OrionLib:MakeWindow({Name = "Regret this Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "RegretThis", IntroEnabled = false, IntroText = "Regret this Hub"})
